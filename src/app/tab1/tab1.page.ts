...
export class Tab1Page implements OnInit {
    ...
    pickImage() {
        const image = Plugins.Camera.getPhoto({quality: 60, allowEditing: true, resultType: CameraResultType.Base64}).then((image) => {
    ...
    submit() {
        ...
        this.authService.create_report(this.report.description, this.report.location.lng, this.report.location.lat).pipe(switchMap((res) => {
